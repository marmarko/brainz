/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/dev/null` (hash: 32be9908314650ff51630d5324018ba2)
// Runtime types generated with workerd@1.20260811.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	MCP_FLEET: DurableObjectNamespace<import("./src/mcp/router").McpFleet>;
	WORKER_FLEET: DurableObjectNamespace<import("./src/mcp/router").WorkerFleet>;
	WEB_FLEET: DurableObjectNamespace<import("./src/mcp/router").WebFleet>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/mcp/router");
		durableNamespaces: "McpFleet" | "WorkerFleet" | "WebFleet";
	}
